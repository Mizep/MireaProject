...
public class AdapterCell extends RecyclerView.Adapter<AdapterCell.StoryHolder>{
    List<ru.mirea.zimin.mireaproject.ui.history.Cell> histories;

    public AdapterCell(List<ru.mirea.zimin.mireaproject.ui.history.Cell> histories){
    ...
    class StoryHolder extends RecyclerView.ViewHolder{
        ...
        void bind(int listIndex){
            ru.mirea.zimin.mireaproject.ui.history.Cell cell = histories.get(listIndex);
